...
# define IN_OUT
# include "IDTDef.h"
# include "libIDT_Device.h" //added to solve the problem,which caused the lacking of pWP_callBack. Danny 2023/5
...
int
device_SendDataCommand(IN BYTE * cmd, IN int cmdLen, IN BYTE * data, IN int dataLen, OUT BYTE * response,
  IN_OUT int * respLen);
 ...
 */
int
device_updateFirmware(IN BYTE * firmwareData, IN int firmwareDataLen, IN char * firmwareName, IN int encryptionType,
  IN BYTE * keyBlob, IN int keyBlobLen);
...
int
device_controlLED(byte indexLED, byte control, int intervalOn, int intervalOff);
 ...
 */
int
device_controlLED_ICC(int controlMode, int interval);
...
int
device_controlLED_MSR(byte control, int intervalOn, int intervalOff);
 ...
 */
int
device_controlBeep(int index, int frequency, int duration);
 ...
 */
int
device_getDRS(BYTE * codeDRS, int * codeDRSLen);
...
int
config_setLEDController(IN int firmwareControlMSRLED, IN int firmwareControlICCLED);
 ...
 */
int
config_getLEDController(OUT int * firmwareControlMSRLED, OUT int * firmwareControlICCLED);
...
int
config_setBeeperController(IN int firmwareControlBeeper);
 ...
 */
int
config_getBeeperController(OUT int * firmwareControlBeeper);
 ...
 */
int
config_setEncryptionControl(IN int msr, IN int icc);
 ...
 */
int
config_getEncryptionControl(OUT int * msr, OUT int * icc);
 ...
 */
int
icc_exchangeEncryptedAPDU(IN BYTE * c_APDU, IN int cLen, OUT BYTE * reData, IN_OUT int * reLen);
 ...
 */
int
icc_getAPDU_KSN(OUT BYTE * KSN, IN_OUT int * inLen);
 ...
 */
int
icc_getFunctionStatus(OUT int * enabled, OUT int * withNotification);
 ...
 */
int
emv_getEMVKernelCheckValue(OUT BYTE * checkValue, IN_OUT int * checkValueLen);
 ...
 */
int
emv_getEMVConfigurationCheckValue(OUT BYTE * checkValue, IN_OUT int * checkValueLen);
...
int
emv_startTransaction(IN double amount, IN double amtOther, IN int exponent, IN int type, IN int timeout, IN BYTE * tags,
  IN int tagsLen, IN int forceOnline);
...
int
emv_activateTransaction(IN int timeout, IN BYTE * tags, IN int tagsLen, IN int forceOnline);
 ...
 */
int
emv_completeTransaction(IN int commError, IN BYTE * authCode, IN int authCodeLen,
 ...
 */
int
emv_retrieveTransactionResult(IN BYTE * tags, IN int tagsLen, IDTTransactionData * cardData);
 ...
 */
int
emv_callbackResponseLCD(IN int type, byte selection);
 ...
 */
int
emv_retrieveApplicationData(IN BYTE * AID, IN int AIDLen, OUT BYTE * tlv, IN_OUT int * tlvLen);
 ...
 */
int
emv_setApplicationData(IN BYTE * name, IN int nameLen, IN BYTE * tlv, IN int tlvLen);
 ...
 */
int
emv_removeApplicationData(IN BYTE * AID, IN int AIDLen);
 ...
 */
int
emv_retrieveAIDList(OUT BYTE * AIDList, IN_OUT int * AIDListLen);
 ...
 */
int
emv_retrieveTerminalData(OUT BYTE * tlv, IN_OUT int * tlvLen);
 ...
 */
int
emv_setTerminalData(IN BYTE * tlv, IN int tlvLen);
 ...
 */
int
emv_retrieveCAPK(IN BYTE * capk, IN int capkLen, OUT BYTE * key, IN_OUT int * keyLen);
 ...
 */
int
emv_setCAPK(IN BYTE * capk, IN int capkLen);
 ...
 */
int
emv_removeCAPK(IN BYTE * capk, IN int capkLen);
 ...
 */
int
emv_retrieveCRL(OUT BYTE * list, IN_OUT int * lssLen);
 ...
 */
int
emv_setCRL(IN BYTE * list, IN int lsLen);
 ...
 */
int
emv_removeCRL(IN BYTE * list, IN int lsLen);
 ...
 */
int
msr_getMSRData(OUT BYTE * reData, IN_OUT int * reLen);
 ...
 */
void
parseMSRData(IN BYTE * resData, IN int resLen, IN_OUT IDTMSRData * cardData);
...
int
msr_captureMode(IN int isBufferMode, IN int withNotification);
 ...
 */
int
msr_setSetting(IN BYTE setting, IN BYTE * val, IN int valLen);
 ...
 */
int
msr_getSetting(IN byte setting, OUT BYTE * value, IN_OUT int * valueLen);
 ...
 */
int
msr_setSwipeForcedEncryptionOption(IN int track1, IN int track2, IN int track3, IN int track3card0);
 ...
 */
int
msr_getSwipeForcedEncryptionOption(OUT BYTE * option);
 ...
 */
int
msr_setSwipeMaskOption(IN int track1, IN int track2, IN int track3);
 ...
 */
int
msr_getSwipeMaskOption(OUT BYTE * option);
 ...
 */
int
msr_setExpirationMask(IN int mask);
 ...
 */
int
msr_getExpirationMask(OUT BYTE * value);
 ...
 */
int
msr_getClearPANID(OUT BYTE * value);
...
#endif // ifndef __LIBIDT_AUGUSTA_H___
