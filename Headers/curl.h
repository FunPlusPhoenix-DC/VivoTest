...
# else // ifdef CURL_STATICLIB
#  define CURL_EXTERN
# endif // ifdef CURL_STATICLIB
 ...
 * release */
CURL_EXTERN int
curl_strequal(const char * s1, const char * s2);
CURL_EXTERN int
curl_strnequal(const char * s1, const char * s2, size_t n);
 ...
 * target handle.
 */
CURL_EXTERN curl_mime *
curl_mime_init(CURL * easy);
 ...
 * the created part.
 */
CURL_EXTERN curl_mimepart *
curl_mime_addpart(curl_mime * mime);
...
curl_mime_name(curl_mimepart * part, const char * name);
 ...
 */
CURL_EXTERN CURLcode
curl_mime_filename(curl_mimepart * part,
  const char *                     filename);
 ...
 */
CURL_EXTERN CURLcode
curl_mime_type(curl_mimepart * part, const char * mimetype);
 ...
 */
CURL_EXTERN CURLcode
curl_mime_encoder(curl_mimepart * part,
  const char *                    encoding);
 ...
 */
CURL_EXTERN CURLcode
curl_mime_data(curl_mimepart * part,
 ...
 */
CURL_EXTERN CURLcode
curl_mime_filedata(curl_mimepart * part,
  const char *                     filename);
 ...
 */
CURL_EXTERN CURLcode
curl_mime_data_cb(curl_mimepart * part,
  curl_off_t                      datasize,
 ...
 */
CURL_EXTERN CURLcode
curl_mime_subparts(curl_mimepart * part,
  curl_mime *                      subparts);
 ...
 */
CURL_EXTERN CURLcode
curl_mime_headers(curl_mimepart * part,
 ...
 */
CURL_EXTERN char *
curl_getenv(const char * variable);
 ...
 */
CURL_EXTERN char *
curl_easy_escape(CURL * handle,
  const char *          string,
  int                   length);

/* the previous version: */
CURL_EXTERN char *
curl_escape(const char * string,
  int                    length);
 ...
 */
CURL_EXTERN char *
curl_easy_unescape(CURL * handle,
  const char *            string,
  int                     length,
  int *                   outlength);
...
/* the previous version */
CURL_EXTERN char *
curl_unescape(const char * string,
  int                      length);
 ...
 */
CURL_EXTERN void
curl_slist_free_all(struct curl_slist *);
 ...
 */
CURL_EXTERN time_t
curl_getdate(const char * p, const time_t * unused);
...
CURL_EXTERN CURLSHcode
curl_share_setopt(CURLSH *, CURLSHoption option, ...);
CURL_EXTERN CURLSHcode
 ...
 */
CURL_EXTERN CURLcode
curl_easy_pause(CURL * handle, int bitmask);
