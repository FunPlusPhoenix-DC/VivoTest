...
#  endif // if defined(_UWIN) && PTW32_LEVEL >= PTW32_LEVEL_MAX
...
PTW32_DLLPORT int PTW32_CDECL
pthread_attr_getschedpolicy(const pthread_attr_t *,
  int *);
 ...
 */
PTW32_DLLPORT int PTW32_CDECL
pthread_win32_test_features_np(int);
enum ptw32_features {
...
PTW32_DLLPORT int PTW32_CDECL
pthreadCancelableTimedWait(HANDLE waitHandle,
  DWORD                           timeout);
...
__declspec(dllimport) extern int * __cdecl
_errno(void);
#      define errno (*_errno())
#     endif
#    endif
